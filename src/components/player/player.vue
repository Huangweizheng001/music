...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      _getPosAndScale() {
        const targetWidth = 40 / 37.5 * (htmlWidth / 10)
        const paddingLeft = 40 / 37.5 * (htmlWidth / 10)
        const paddingBottom = 30 / 37.5 * (htmlWidth / 10)
        const paddingTop = 80 / 37.5 * (htmlWidth / 10)
